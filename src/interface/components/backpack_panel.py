...
class BackpackPanel(UIComponent):
    def __init__(self, game_manager: GameManager):
        ...
        self.banner = pg.transform.smoothscale(banner_raw, (410, 80)) # 加寬到 410

        # Fonts
        self.font_title = pg.font.Font("assets/fonts/Minecraft.ttf", 36)
        self.font_text = pg.font.Font("assets/fonts/Minecraft.ttf", 22) # 字體加大
        ...
        # 定義區域：左側(怪物) / 右側(道具)
        # 左右各佔約 420px，中間留 40px 間距
        # y+100 留給標題更多空間
        self.clip_mon = pg.Rect(x + 40, y + 100, 420, 510)
        self.clip_item = pg.Rect(x + 500, y + 100, 420, 510)
        ...
        self.COLOR_BG_BAR = (50, 50, 50)      # Dark Grey for bar background
        self.COLOR_SCROLL_HANDLE = (50, 50, 50) # 滾動條加深
    ...
    def update(self, dt: float):
        ...
        mon_h = max(self.clip_mon.height, mon_count * 90) # 項目高度增加
    ...
    def draw(self, screen: pg.Surface):
        ...
        for mon in monsters:
            ...
            surf_mon.blit(lv_txt, (info_x + 200, y + 10))
        ...
        if not items:
            ...
            for it in items:
                # 道具分隔線 (深色)
                pg.draw.line(surf_item, (200, 200, 200), (10, iy + item_row_h - 2), (400, iy + item_row_h - 2), 1)
                ...
                surf_item.blit(cnt_s, (350, iy + 20))
